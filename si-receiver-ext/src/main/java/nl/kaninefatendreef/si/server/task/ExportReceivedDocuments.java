...
public class ExportReceivedDocuments {
	...
	@Autowired
	ActiveExportService activeExportService;
	...
	public void processNotProcessed(){
		...
		for (SimplerInvoiceDocument simplerInvoiceDocument : simplerInvoiceDocuments){
			try{
				...
				ExportServiceResult exportServiceResult = activeExportService.export(simplerInvoiceDocument);
	...
	public void processProcessedSuccess(){
		...
		for (SimplerInvoiceDocument simplerInvoiceDocument : simplerInvoiceDocuments){
			try{
				if (activeExportService.exportSuccess(simplerInvoiceDocument))
				{
