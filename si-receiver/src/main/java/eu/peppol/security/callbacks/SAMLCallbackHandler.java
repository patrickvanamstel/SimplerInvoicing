...
import eu.peppol.start.model.OxalisConstant;
...
public class SAMLCallbackHandler implements CallbackHandler {
	...
	public final Element sign(Assertion assertion,
        ...
        try {
            ...
            //Reference reference = signatureFactory.newReference("#" + assertion.getID(), digestMethod, transformList, null, assertion.getID());
