...
public class SAMLCallbackHandler implements CallbackHandler {
     ...
     *
     *	http://www.coderanch.com/t/550324/Websphere/SAML-Sender-Vouches
     *
    ...
    private Element createSenderVouchesSAMLAssertion(SAMLCallback samlCallback) throws Exception {
        ...
        //OxalisConstant.PEPPOL_SENDER_ID;

//TODO
        String senderId = "busdox:sender";;//OxalisConstant.PEPPOL_SENDER_ID;
//TODO
        String accesspointName = "accessPointService";//OxalisConstant.PEPPOL_SERVICE_NAME;
        ...
        Element elementSigned = sign(assertion, keyStoreManager.getCertificate(), keyStoreManager.getPrivateKey());
        
        return elementSigned;
    }
